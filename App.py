...
st.logo("https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Emblem_of_Israel_Police.svg/1106px-Emblem_of_Israel_Police.svg.png")
...
fig.update_layout(barmode='relative', bargap=0.2, xaxis_title=dict(
        ...
        text="קבוצת העבירות",
        font=dict(size=20)  # Increase the text size
    ), title_x=0.6, height=650,hoverlabel=dict(font_size=20),
    legend=dict(font=dict(size=15)))
fig.update_traces(
